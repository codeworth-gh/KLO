...
# HealthRelatedRights/Duties/requestWorkplaceAdjustments
בקשה להתאמת מקום העבודה
על העובד לבקש את התאמת מקום העבודה למגבלותיו, על מנת שיוכל לבצע את עבודתו
---
על העובד לבקש את ההתאמות הדרושות לו ולנמק את בקשתו, ועל המעסיק חלה חובה לספק את ההתאמות הנדרשות בהתאם לבקשה, אלא אם ביצוע ההתאמות מטיל על המעסיק נטל בלתי סביר בנסיבות העניין.
...
ישנן מספר סוגיות התאמות, ביניהן התאמות פיזיות, כמו למשל הנגשה פיזית של מקום העבודה:

* התקנת מעלית או מעלון לעובד המתנייד בכיסא גלגלים, הרחבת דלת הכניסה למקום העבודה כדי לאפשר מעבר של כיסא גלגלים, התקנת בית שימוש נגיש וכו'.
* התאמה של עמדת העבודה האישית באמצעות התאמת הציוד, או רכישת אמצעי עזר: רכישת מסך מחשב גדול עבור עובד כבד ראייה למשל, המקל עליו לקרוא מהמחשב.
* שינוי בנהלי עבודה במקרים מסוימים, כגון התאמה של דרישות התפקיד או שעות העבודה
* התאמות הקשורות בהכשרה ובהדרכה של העובד: במקרה בו העובד אינו יכול לעבוד שעות עבודה רבות ברצף בשל מוגבלותו, ניתן לאפשר לו לצאת למספר הפסקות במקום העבודה, לחלק את שעות העבודה או לעבוד מביתו.
