...
אישור תקופת עבודה
מכתב שעל המעסיק לתיתו עם סיום ההעסקה. מכתב זה כולל תאריך תחילת ההעסקה ותאריך סיומה, והוא נועד לכל שימוש של העובד.
(שאדי: האם זה לא אותו מכתב של אישור סיום העסקה)
...
גמר חשבון
התחשבנות כספית בין המעסיק לעובד באשר לשווי הזכויות המגיעות לעובד בעת סיום העסקתו ובעקבותיה, וכולל מסמכים שעל המעסיק למסור לעובד בעקבות סיום היחסים.
---
...
מכתב אישור סיום העסקה (מכתב פיטורים)
המעסיק צריך לתת לעובד הודעה כתובה על סיום ההעסקה, המפרטת את התקופה שבה הועסק העובד אצל המעסיק.
---
...
הגרי עבודה בהיתר אינם רשאים לשהות בישראל למעלה מ-90 ימים בלא מעסיק, ומסתכנים באובדן אשרה ובהרחקה מישראל אם לא ימצאו מעסיק חדש תוך 90 ימים לכל היותר מרגע סיום ההעסקה אצל מעסיקם הקודם.

# EndOfWork/Duties/healthInsuranceExtension
הארכת ביטוח רפואי
 עם סיום ההעסקה, המעסיק רשאי להפסיק לעובד הזר את דמי הביטוח הרפואי , לכן חשוב שהעובד הזר ימשיך את תשלומי הביטוח הרפואי באופן עצמאי לאחר סיום ההעסקה ועד למציאת מעסיק חדש שייקח על עצמו את התשלום, כדי לא לאבד זכויות בריאותיות.
---

# EndOfWork/Duties/employeePriorNoticeForEmploymentChange
הודעה על התפטרות מותנית
כאשר מדובר בהתפטרות עקב הרעת תנאים, על העובד להתריע מראש על ההרעה בתנאים ועל כוונתו להתפטר ולתת למעסיק הזדמנות נאותה לתקן את מה שמצריך תיקון ככל שהדבר ניתן לתיקון.
---
...
הגשת בקשה לשחרור פקדון
יש להגיש בקשה לשחרור כספי פיקדון עובדים זרים
---
...
זכאות לטיסה הביתה, שתשולם על ידי ביטוח לאומי.

# EndOfWork/Benefits/Properties/eligibleForFlightExpensePI
זכאות לטיסה למדינת המקור
זכאות לטיסה למדינת המקור, משולמת על ידי ביטוח פרטי.
...
המלצות
פעולות שהעובד יכול לעשות, אבל לא חייב.
...
זכאות להטבת מס רטרואקטיבית
מיקום המגורים החדש מזכה את העובד בהטבת מס רטרואקטיבית לאחר שנה.

# EndOfWork/Recommendations/payKeens
תשלום שארים
התשלום מתחלק בין השארים של העובד. אין צורך לחכות להשלמת צו הירושה.
...
שהות בישראל של יותר מחודשיים עלולה להפחית את תשלומי הפיצויים להם העובד זכאי.
...
דיווח למשטרה
נראה כי המעסיק עבר על החוק במהלך סיום ההעסקה
